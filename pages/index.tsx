    ...
    <>
      ...
      <main className="min-h-screen bg-black text-white">
        <header className="fixed inset-x-0 top-0 z-[80] border-b border-white/10 bg-black/52 px-4 py-4 backdrop-blur-2xl sm:px-6 lg:px-10">
          <nav
            className="mx-auto grid max-w-[1500px] grid-cols-[1fr_auto] items-center gap-4 lg:grid-cols-[1fr_auto_1fr]"
            aria-label="Primary navigation">
            <a
              href="#"
              className="text-xs font-black uppercase tracking-[0.28em] text-white">
              Project 12
            </a>
        ...
        <section
          ...
          <div
            ...
            <p className="max-w-[19rem] text-xs leading-5 text-white/62 sm:max-w-sm sm:text-base sm:leading-7">
              A cinematic hero system for premium real-estate storytelling,
              designed with brutalist restraint, soft glass overlays, responsive
              hierarchy, and a floating product-grade device scene.
            </p>
        ...
        <section
          id="overview"
          className="relative scroll-mt-24 bg-black px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
          <div className="mx-auto grid max-w-[1500px] gap-12 lg:grid-cols-[0.78fr_1.22fr]">
            <div className="reveal-blur">
              <p className="mb-5 text-xs font-semibold uppercase tracking-[0.32em] text-[#A78BFA]">
                Scroll System
              </p>
            ...
            <div className="grid gap-px bg-white/12 md:grid-cols-3">
              {projectStats.map((stat) => (
                <article
                  key={stat.label}
                  className="reveal-blur min-h-56 bg-black p-6">
                  <p className="text-6xl font-black tracking-[-0.08em] text-white">
                    {stat.value}
                  </p>
                  <p className="mt-20 text-xs font-semibold uppercase tracking-[0.28em] text-white/45">
                    {stat.label}
                  </p>
                </article>
              ))}
        ...
        <section
          id="concept"
          className="relative scroll-mt-24 overflow-hidden bg-black px-4 py-20 sm:px-6 lg:px-10 lg:py-32">
          <div className="mx-auto grid max-w-[1500px] gap-14 border-t border-white/10 pt-10 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="reveal-blur lg:sticky lg:top-10 lg:self-start">
              <p className="mb-6 text-xs font-semibold uppercase tracking-[0.32em] text-white/42">
                01 / Concept
              </p>
              <h2 className="text-[16vw] font-black uppercase leading-[0.78] tracking-[-0.08em] text-white lg:text-[8.6vw]">
                Digital
                <span className="block pl-[10vw] text-white/50 lg:pl-[5vw]">
                  Estate
                </span>
                System
              </h2>
            ...
            <div className="grid gap-10">
              <p className="reveal-blur max-w-3xl text-2xl leading-tight tracking-[-0.04em] text-white/76 sm:text-4xl lg:text-5xl">
                Project 12 is presented as a premium architectural interface:
                less decoration, more atmosphere, with the laptop mockup treated
                like a luxury object inside a cinematic black set.
              </p>
              <div className="reveal-blur grid gap-px bg-white/10 sm:grid-cols-2">
                <div className="min-h-60 bg-black p-6">
                  ...
                  <p className="mt-24 text-xl leading-snug text-white/66">
                    Dark, quiet, sharp, spatial, and intentionally over-scaled.
                  </p>
                </div>
                <div className="min-h-60 bg-black p-6">
                  <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#A78BFA]">
                  ...
                  <p className="mt-24 text-xl leading-snug text-white/66">
                    Parallax movement, glass labels, editorial reveals, and a
                    controlled sense of depth.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section
          id="showcase"
          className="scroll-mt-24 bg-black px-4 py-20 sm:px-6 lg:px-10 lg:py-32">
          <div className="mx-auto max-w-[1500px]">
            <div className="reveal-blur mb-12 flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
              ...
              <p className="max-w-sm text-sm leading-6 text-white/46">
                Large architectural visuals carry the page, while typography
                breaks the grid and glass UI tags act like interface artifacts.
              </p>
            </div>
              ...
              {showcaseItems.map((item, index) => (
                <article
                  ...
                  <div className="absolute inset-x-5 bottom-5 border border-white/14 bg-black/28 p-5 backdrop-blur-xl">
                    ...
                    <h3 className="mt-5 text-3xl font-black uppercase leading-[0.9] tracking-[-0.05em] text-white">
                      {item.title}
                    </h3>
                  </div>
                </article>
        ...
        <section
          ...
          <div className="mx-auto max-w-[1500px] border-y border-white/10">
            {systemRows.map((row, index) => (
              <div
                key={row[0]}
                className="reveal-blur grid gap-6 border-b border-white/10 py-8 last:border-b-0 lg:grid-cols-[120px_1fr_1fr] lg:items-center">
                <p className="text-sm font-semibold uppercase tracking-[0.28em] text-white/35">
                  {String(index + 1).padStart(2, "0")}
                </p>
                <h3 className="text-4xl font-black uppercase leading-none tracking-[-0.06em] text-white sm:text-6xl">
                  {row[0]}
                </h3>
                <div>
        ...
        <section
          id="gallery"
          className="scroll-mt-24 overflow-hidden bg-black py-20 lg:py-32">
          <div className="mx-auto max-w-[1500px] px-4 sm:px-6 lg:px-10">
            <p className="reveal-blur mb-5 text-xs font-semibold uppercase tracking-[0.32em] text-[#A78BFA]">
              03 / Gallery
            </p>
            ...
            {galleryImages.map((src, index) => (
              <figure
                ...
                className={`reveal-blur relative shrink-0 snap-center overflow-hidden border border-white/10 bg-zinc-950 ${
                  index % 2 === 0
                    ? "h-[560px] w-[82vw] sm:w-[620px]"
                    : "h-[460px] w-[76vw] self-end sm:w-[500px]"
                }`}>
                <Image
                  className="object-cover opacity-80 transition duration-700 hover:scale-105 hover:opacity-100"
                  src={src}
                  alt={`Project 12 gallery frame ${index + 1}`}
                  fill
                  sizes="620px"
                />
          ...
          <div className="relative mx-auto grid max-w-[1500px] gap-10 lg:grid-cols-[1fr_520px] lg:items-end">
            ...
            <div className="grid gap-3">
              {responsiveNotes.map((note) => (
                <div
                  key={note}
                  className="reveal-blur border border-white/12 bg-white/[0.06] p-5 text-lg font-semibold tracking-[-0.03em] text-white/75 backdrop-blur-xl">
                  {note}
                </div>
              ))}
            </div>
        ...
        <section
          id="launch"
          className="scroll-mt-24 bg-black px-4 py-24 sm:px-6 lg:px-10 lg:py-36">
          <div className="mx-auto max-w-[1500px]">
            <div className="reveal-blur border border-white/12 bg-white/[0.04] p-6 backdrop-blur-xl sm:p-10 lg:p-14">
              <p className="mb-6 text-xs font-semibold uppercase tracking-[0.32em] text-[#A78BFA]">
                05 / Launch
              </p>
        ...
        <footer className="border-t border-white/10 bg-black px-4 py-8 text-center sm:px-6 lg:px-10">
          <div className="mx-auto flex max-w-[1500px] flex-col items-center justify-center gap-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/48 sm:flex-row sm:flex-wrap sm:gap-x-4 sm:gap-y-2">
            <p>Copyrights © {copyrightYear}</p>
            <a
              href="https://check-ai.vercel.app/"
              target="_blank"
              rel="noreferrer"
              className="text-white/72 transition hover:text-white">
              Project 12
            </a>
            <span className="hidden text-white/22 sm:inline">|</span>
